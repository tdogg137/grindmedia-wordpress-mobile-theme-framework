<?php
	...
	$posts = grindmedia_get_posts( array( 'category_name' => '', 'offset' => $_GET['start'], 'posts_per_page' => $_GET['desiredPosts']) );
	...
	echo grindmedia_get_posts( array( 'category_name' => '', 'offset' => $_GET['start'], 'posts_per_page' => $_GET['desiredPosts']) );
	/* kill the page */
	die();
    }
