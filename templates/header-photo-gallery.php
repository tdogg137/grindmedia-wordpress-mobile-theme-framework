...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo THEME_URL.'/css/photoswipe.css'; ?>" />
...
<?php //wp_head(); ?>
        ...
        <script src="<?php echo THEME_URL.'/js/libs/photoswipe/klass.min.js'; ?>"></script>
        <script src="<?php echo THEME_URL.'/js/libs/photoswipe/code.photoswipe-3.0.5.min.js'; ?>"></script>
