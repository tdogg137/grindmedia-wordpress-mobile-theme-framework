                ...
                <script>
                    var slider = new Swipe( document.getElementById('slider'), {
                        callback: function(event, index, elem) {
                            ...
                            var count = jQuery('.thumbs-wrapper ul').children().length;
                            
                            if(index == 0) {
                                jQuery('.slider-prev').css('visibility', 'hidden');
                            } else {
                                jQuery('.slider-prev').css('visibility', 'visible');
                            }
                            
                            if(index == (count-1)) {
                                jQuery('.slider-next').css('visibility', 'hidden');
                            } else {
                                jQuery('.slider-next').css('visibility', 'visible');
                            }
